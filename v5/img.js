tjs.imgUtil = {
	...
	downScaleImageFile:function(file, maxWidth, callback){
		var contentType = this.imgType(file.name);
		if (!contentType) {
			callback('Not a image file',null);
		}
		var self = this;
		...
		reader.onload = function(e) {
			...
			img.onload = function(e) {
				...
				var canvas = self.downScaleImage(img, scale);
				var dataURL = canvas.toDataURL(contentType);
				var bString = atob(dataURL.split(',')[1]);
				...
				callback(null,blob,contentType);
			};
